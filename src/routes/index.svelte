...
<section class="px-2 py-32 bg-white md:px-0">
	  ...
	  <div class="flex flex-wrap items-center sm:-mx-3">
		<div class="w-full md:w-1/2 md:px-3">
		  <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
			...
			<p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl"> Create Beautiful Success Pages designed to convert.
				It's never been easier to build pages that convey your message and tell your story.</p>
  ...
  <section class="pt-24 bg-white">
    <div class="container max-w-6xl mx-auto">
        <h2 class="text-4xl font-bold tracking-tight text-center">Why FactorPage ?</h2>
        <p class="mt-2 text-lg text-center text-gray-600">Here's why top-performing revenue teams use FactorPage to streamline how they engage with prospects and customers.</p>
